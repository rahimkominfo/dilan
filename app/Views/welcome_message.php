...
<!-- Tailwind CSS Success Banner -->
<div class="bg-gradient-to-r from-orange-500 to-red-600 text-white py-4 px-6 text-center font-semibold shadow-md flex items-center justify-center gap-3">
    <span class="bg-white text-orange-600 text-xs uppercase px-2.5 py-1 rounded-full font-bold tracking-wider shadow-sm">Tailwind CSS Active</span>
    <span>Tailwind CSS v3 has been successfully installed and configured with PostCSS!</span>
</div>
