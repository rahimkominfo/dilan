 ...
 */
export declare function isSizeStyleValue(value: string): boolean;
/**
 ...
 */
export declare function isOriginStyleValue(string: string): boolean;
/**
 * Checks if string contains [background clip](https://developer.mozilla.org/en-US/docs/Web/CSS/background-clip) CSS value.
 */
export declare function isClipStyleValue(string: string): boolean;
/**
